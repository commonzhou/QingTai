...
$.ajax({
    ...
    success: function(data) {
        ...
        //alert(stringdata);
        datas[0] = newjson.result[3];
        datas[1] = newjson.result[2];
        datas[2] = newjson.result[1];
        datas[3] = newjson.result[0];
...
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[4] = newjson.result[3];
        datas[5] = newjson.result[2];
        datas[6] = newjson.result[1];
        datas[7] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click");
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[8] = newjson.result[3];
        datas[9] = newjson.result[2];
        datas[10] = newjson.result[1];
        datas[11] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click");
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[12] = newjson.result[3];
        datas[13] = newjson.result[2];
        datas[14] = newjson.result[1];
        datas[15] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[16] = newjson.result[3];
        datas[17] = newjson.result[2];
        datas[18] = newjson.result[1];
        datas[19] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[20] = newjson.result[3];
        datas[21] = newjson.result[2];
        datas[22] = newjson.result[1];
        datas[23] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[24] = newjson.result[6];
        datas[25] = newjson.result[5];
        datas[26] = newjson.result[4];
        datas[27] = newjson.result[3];
        datas[28] = newjson.result[2];
        datas[29] = newjson.result[1];
        datas[30] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[31] = newjson.result[6];
        datas[32] = newjson.result[5];
        datas[33] = newjson.result[4];
        datas[34] = newjson.result[3];
        datas[35] = newjson.result[2];
        datas[36] = newjson.result[1];
        datas[37] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[38] = newjson.result[6];
        datas[39] = newjson.result[5];
        datas[40] = newjson.result[4];
        datas[41] = newjson.result[3];
        datas[42] = newjson.result[2];
        datas[43] = newjson.result[1];
        datas[44] = newjson.result[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        //$("#month").trigger("click"); 
    }
});
...
$("#date").click(function() {
    ...
    option.xAxis.data = [gettedMonth + '-' + (moment().subtract(6, 'd').date()), gettedMonth + '-' + (moment().subtract(5, 'd').date()), gettedMonth + '-' + (moment().subtract(4, 'd').date()), gettedMonth + '-' + (moment().subtract(3, 'd').date()),
        gettedMonth + '-' + (moment().subtract(2, 'd').date()), gettedMonth + '-' + (moment().subtract(1, 'd').date()), gettedMonth + '-' + gettedDate
    ];
...
$("#query").click(function() { //  post三请求
    ...
    $.ajax({
        ...
        success: function(data) {
            var stringdata = JSON.stringify(data);
            var newjson = JSON.parse(stringdata);
            datas[45] = newjson.result[6];
            datas[46] = newjson.result[5];
            datas[47] = newjson.result[4];
            datas[48] = newjson.result[3];
            datas[49] = newjson.result[2];
            datas[50] = newjson.result[1];
            datas[51] = newjson.result[0];
            $("#query").trigger("click");
        }
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            var stringdata = JSON.stringify(data);
            var newjson = JSON.parse(stringdata);
            datas[52] = newjson.result[6];
            datas[53] = newjson.result[5];
            datas[54] = newjson.result[4];
            datas[55] = newjson.result[3];
            datas[56] = newjson.result[2];
            datas[57] = newjson.result[1];
            datas[58] = newjson.result[0];
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var newjson = JSON.parse(stringdata);
            //alert(stringdata);
            datas[59] = newjson.result[6];
            datas[60] = newjson.result[5];
            datas[61] = newjson.result[4];
            datas[62] = newjson.result[3];
            datas[63] = newjson.result[2];
            datas[64] = newjson.result[1];
            datas[65] = newjson.result[0];
        }
    });
    var timeSave = new Array();

    for (let i = 0; i < 7; i++) {
        timeSave[i] = moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday });
    }

    option.xAxis.data = [
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(6, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(6, 'd').date()),
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(5, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(5, 'd').date()),
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(4, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(4, 'd').date()),
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(3, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(3, 'd').date()),
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(2, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(2, 'd').date()),
        (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(1, 'd').month() + 1) + '-' + (moment().set({ 'year': newyear, 'month': newmonth - 1, 'date': newday }).subtract(1, 'd').date()),
        newmonth + '-' + newday
        //此处使用了moment.js来对当前日期做减法
        //此处每次新建一个moment对象设置成用户输入的信息，如果只新建一个，运算时会相互影响
    ];
