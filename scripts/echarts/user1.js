...
$.ajax({
    ...
    success: function(data) {
        ...
        //alert(stringdata);
        datas[0] = newjson.hresult[3];
        datas[1] = newjson.hresult[2];
        datas[2] = newjson.hresult[1];
        datas[3] = newjson.hresult[0];
        datas2[0] = newjson.sresult[3];
        datas2[1] = newjson.sresult[2];
        datas2[2] = newjson.sresult[1];
        datas2[3] = newjson.sresult[0];
...
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[4] = newjson.hresult[3];
        datas[5] = newjson.hresult[2];
        datas[6] = newjson.hresult[1];
        datas[7] = newjson.hresult[0];
        datas2[4] = newjson.sresult[3];
        datas2[5] = newjson.sresult[2];
        datas2[6] = newjson.sresult[1];
        datas2[7] = newjson.sresult[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click"); //模拟点击来保证打开时主页有数值
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[8] = newjson.hresult[6];
        datas[9] = newjson.hresult[5];
        datas[10] = newjson.hresult[4];
        datas[11] = newjson.hresult[3];
        datas[12] = newjson.hresult[2];
        datas[13] = newjson.hresult[1];
        datas[14] = newjson.hresult[0];
        datas2[8] = newjson.sresult[6];
        datas2[9] = newjson.sresult[5];
        datas2[10] = newjson.sresult[4];
        datas2[11] = newjson.sresult[3];
        datas2[12] = newjson.sresult[2];
        datas2[13] = newjson.sresult[1];
        datas2[14] = newjson.sresult[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click"); //模拟点击来保证打开时主页有数值
    }
});
