...
$.ajax({
    ...
    success: function(data) {
        ...
        //alert(stringdata);
        datas[0] = newjson.presult[3];
        datas[1] = newjson.presult[2];
        datas[2] = newjson.presult[1];
        datas[3] = newjson.presult[0];
        datas2[0] = newjson.aresult[3];
        datas2[1] = newjson.aresult[2];
        datas2[2] = newjson.aresult[1];
        datas2[3] = newjson.aresult[0];
...
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[4] = newjson.presult[3];
        datas[5] = newjson.presult[2];
        datas[6] = newjson.presult[1];
        datas[7] = newjson.presult[0];
        datas2[4] = newjson.aresult[3];
        datas2[5] = newjson.aresult[2];
        datas2[6] = newjson.aresult[1];
        datas2[7] = newjson.aresult[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click"); //模拟点击来保证打开时主页有数值
    }
});
$.ajax({
    ...
    success: function(data) {
        ...
        var newjson = JSON.parse(stringdata);
        //alert(stringdata);
        datas[8] = newjson.presult[6];
        datas[9] = newjson.presult[5];
        datas[10] = newjson.presult[4];
        datas[11] = newjson.presult[3];
        datas[12] = newjson.presult[2];
        datas[13] = newjson.presult[1];
        datas[14] = newjson.presult[0];
        datas2[8] = newjson.aresult[6];
        datas2[9] = newjson.aresult[5];
        datas2[10] = newjson.aresult[4];
        datas2[11] = newjson.aresult[3];
        datas2[12] = newjson.aresult[2];
        datas2[13] = newjson.aresult[1];
        datas2[14] = newjson.aresult[0];
        // alert(datas);                            如果在ajax外的话，可能来不及获取，导致值为空
        $("#month").trigger("click"); //模拟点击来保证打开时主页有数值
    }
});
